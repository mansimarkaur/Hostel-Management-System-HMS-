...
else
{
    ...
    if(false===strpos((string)$result,"Can't"))
    {
        while ($row = mysql_fetch_array($result)) {
            $GLOBALS['isData1']="1";
            $GLOBALS['output1'] .= '<option value="'.$row['empId'].'">'.$row['name'].'</option>';
...
function getTableData($userId,$db)
{
    ...
    if ($msg = "true") {
        ...
        $query="SELECT a.serial, b.name,a.date,a.isAbsence ,a.isLeave,a.remark FROM emp_att as a,employee as b where a.userId='".$userId."' and a.userID=b.empId and b.isActive='Y'";
      ...
      // var_dump($result);
        ...
        {
            echo '<script type="text/javascript"> alert("' . $result . '");window.location="view_emp.php";</script>';
        }
    } else {
        echo '<script type="text/javascript"> alert("' . $msg . '");window.location="view_emp.php";</script>';
    }
        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form name="attendence" action="view_emp.php"  accept-charset="utf-8" method="post" enctype="multipart/form-data">
